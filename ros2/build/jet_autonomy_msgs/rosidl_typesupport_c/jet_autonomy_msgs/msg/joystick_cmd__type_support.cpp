...
static const _JoystickCmd_type_support_symbol_names_t _JoystickCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jet_autonomy_msgs, msg, JoystickCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, jet_autonomy_msgs, msg, JoystickCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, jet_autonomy_msgs, msg, JoystickCmd)() {
  return &::jet_autonomy_msgs::msg::rosidl_typesupport_c::JoystickCmd_message_type_support_handle;
}
