...
bool jet_autonomy_msgs__msg__jet_drive_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "jet_autonomy_msgs.msg._jet_drive_cmd.JetDriveCmd",
        full_classname_dest, 48) == 0);
  }
  jet_autonomy_msgs__msg__JetDriveCmd * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of JetDriveCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("jet_autonomy_msgs.msg._jet_drive_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JetDriveCmd");
