...
#include "jet_autonomy_msgs/msg/joystick_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const jet_autonomy_msgs::msg::JoystickCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<jet_autonomy_msgs::msg::JoystickCmd *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JoystickCmd__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const jet_autonomy_msgs::msg::JoystickCmd *>(
...
{
  return max_serialized_size_JoystickCmd(full_bounded, 0);
}

static message_type_support_callbacks_t _JoystickCmd__callbacks = {
...
static rosidl_message_type_support_t _JoystickCmd__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JoystickCmd__callbacks,
...
{
  return &jet_autonomy_msgs::msg::typesupport_fastrtps_cpp::_JoystickCmd__handle;
}
